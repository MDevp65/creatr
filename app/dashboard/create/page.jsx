...
const CreatePost = () => {
    ...
    const { data: currentUser, isLoading: isUserLoading } = useConvexQuery(api.users.getCurrentUser)

    if (isDraftLoading || isUserLoading) return <BarLoader width={"100%"} color='#D8B4FE' />
