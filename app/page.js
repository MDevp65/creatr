...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      }} className="fixed w-96 h-96 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-3xl z-0 pointer-events-none"></div>
      ...
      <section className="relative z-10 mt-48 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-7xl lg:text-8xl font-black leading-none tracking-tight">
                ...
                <span className="block font-black bg-gradient-to-r from-blue-400 via-purple-400 to-green-400 text-transparent bg-clip-text">Grow.</span>
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-2xl md:max-w-none">The AI-powered platform that turns your ideas into
                <span className="text-purple-300 font-semibold"> engaging content</span> and helps you to build a thriving creator business.
              </p>
            </div>
          ...
          <div>
            <Image src={"/banner.png"} width={500} height={700} alt="Platform Banner" className="w-full h-auto object-contain rounded-[280px]" priority />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
              From AI-powered writing assistance to advance analytics, we&apos;ve built the complete toolkit for modern creators.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {
              features.map((feature, index) => (
                <Card key={index} className={"group transition-all duration-300 hover:scale-105 card-glass"}>
                  <CardContent>
                    <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform`}>
      ...
      <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
              Three powerufull modules working together to supercharge your content creation.
            </p>
          </div>
              ...
              <div className="space-y-4">
                {
                  platformTabs.map((tab, index) => (
                    <Button key={index} variant={activeTab === index ? "outline" : "ghost"} onClick={() => setActiveTab(index)} className={"justify-start w-full h-auto p-6"}>
              ...
              socialProofStats.map((stat, index) => (
                <div className="text-center" key={index}>
                  <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <stat.icon className="w-6 h-6 sm:w-7 sm:h-7 lg:h-8 lg:w-8 text-white" />
                  </div>
      ...
      <footer className="relative z-10 border-t py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-muted-foreground">
            Made with ❤️ by{" "}
            <span className="text-foreground font-semibold">M-Developer</span>
          </p>
        </div>
      </footer>
    </div>
