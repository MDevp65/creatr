...
import { Check, Crop, ImageIcon, Loader2, RefreshCw, Type, Upload, Wand2, X } from 'lucide-react';
...
const ImageUploadModal = ({ isOpen, onClose, onImageSelect, title = "Upload & Transform Image" }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className={"!max-w-6xl !h-[90vh] overflow-y-autos"}>
                <DialogHeader>
                    <DialogTitle className={"text-white"}>{title}</DialogTitle>
                    <DialogDescription>Upload an image and apply AI-powered transformations</DialogDescription>
                </DialogHeader>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400 mt-2">
                                            or Click to select a file (JPG, PNG, JPEG, WEBP, GIF - MAX-10MB)
                                        </p>
                                    </div>
                                </div>
                            )}
...

                        {
                            uploadedImage && (
                                <div className="text-center space-y-4">
                                    ...
                                    <Button onClick={() => setActiveTab("transform")} className={"bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700"}>
                    ...
                    <TabsContent value="transform" className={"space-y-6"}>
                        <div className="grid lg:grid-cols-2 gap-6 max-h-[60vh] overflow-y-auto">
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Select value={watchedValues.aspectRatio} onValueChange={(value) => setValue("aspectRatio", value)}>
                                            <SelectTrigger>
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent>
                                    ...
                                    {watchedValues.aspectRatio === "custom" && (
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className='space-y-3'>
                                                ...
                                                <Input type={"number"} value={watchedValues.customWidth}
                                                    onChange={(e) => setValue("customWidth", parseInt(e.target.value) || 800)}
                                                    min={"100"} max={"2000"} />
                                            </div>

                                            <div className='space-y-3'>
                                                <Label className={"text-white"}>Height</Label>
                                                <Input type={"number"} value={watchedValues.customHeight}
                                                    onChange={(e) => setValue("customHeight", parseInt(e.target.value) || 600)}
                                                    min={"100"} max={"2000"} />
                                            </div>
...

                                    {
                                        watchedValues.aspectRatio !== "original" && (
                                            <div className="space-y-3">
                                                <Label className={"text-white"}>Smart Crop</Label>
                                                <Select value={watchedValues.smartCropFocus} onValueChange={(value) => setValue("smartCropFocus", value)}>
                                                    <SelectTrigger>
                                                        <SelectValue />
                                                    </SelectTrigger>
                                                    <SelectContent>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Textarea value={watchedValues.textOverlay}
                                            onChange={(e) => setValue("textOverlay", e.target.value)} row={3} placeholder="Enter text to overlay"
                                        />
                                    </div>
                                    ...
                                    {watchedValues.textOverlay && (
                                        <>
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                <div className="space-y-3">
                                                    <Label className={"text-white"}>Postion</Label>
                                                    <Select value={watchedValues.textPosition} onValueChange={(value) => setValue("textPosition", value)}>
                                                        <SelectTrigger>
                                                            <SelectValue />
                                                        </SelectTrigger>
                                                        <SelectContent>
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-semi-bold text-white flex items-center">
