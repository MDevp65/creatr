            ...
            <div className="space-y-8">
                ...
                {watchedValues.featuredImage ? (
                    <div className="relative group">
                        <img src={watchedValues.featuredImage} alt="Featured" className="w-full h-80 object-cover rounded-xl" />
                ...
                <div className="editor-container">
                    <div className="editor-wrapper prose prose-lg max-w-none">
                        <ReactQuill
                            ref={setQuillRef}
                            theme="snow"
