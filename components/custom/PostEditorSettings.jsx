            ...
            <DialogContent className={"max-w-md"}>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        <label htmlFor="tags" className='text-white font-medium text-sm'>Tags</label>
                        <div className="flex space-x-2 pt-2">
                            ...
                            <Button type="button" onClick={addTag} variant={"outline"} size={"sm"} className={"border-slate-600"}>
                    ...
                    <p className="text-xs text-slate-400">{watchedValues.tags.length}/10 tags • Press Enter or comma to add</p>
